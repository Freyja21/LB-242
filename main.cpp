...
*/
// Topic's publish
char* topicTEMP = (char*) "iotkit/sensorMuriel";
char* topicALERT = (char*) "iotkit/alertMuriel";
char* topicBUTTON = (char*) "iotkit/buttonMuriel";
char* topicRFID = (char*) "iotkit/rfidMuriel";
char* topicENCODER = (char*) "iotkit/encoderMuriel";
// Topic's subscribe
char* topicActors = (char*) "iotkit/actors/#";
char * topicOled = (char *) "tinder/oled";
// MQTT Brocker
char* hostname = (char*) "192.168.249.111";
int port = 1883;
// MQTT Message
...
void messageArrived( MQTT::MessageData& md )
{
    ...
    oled.clear();
    oled.printf((char *) message.payload);
    // Aktoren
...
int main()
{
    ...
    data.password.cstring = (char*) "123456789";
    if ((rc = client.connect(data)) != 0)
        printf("rc from MQTT connect is %d\r\n", rc);           

    // MQTT Subscribe!
   
    client.setMessageHandler(topicOled, messageArrived);
    client.subscribe( topicOled, MQTT::QOS0, messageArrived );
